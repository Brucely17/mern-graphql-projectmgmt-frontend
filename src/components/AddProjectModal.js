  ...
  <div className="modal-dialog">
    <div className="modal-content">
      <div className="modal-header">
        <h5 className="modal-title fs-5" id="addProjectModalLabel">New Project</h5>
      ...
      <div className="modal-body">
        <form onSubmit={Submit}>
            ...
            <div className='mb-3'>
                ...
                <textarea type='text' className='form-control' id='description' value={description}
            ...
            <div className='mb-3'>
                <label className='form-label'>status Number</label>
